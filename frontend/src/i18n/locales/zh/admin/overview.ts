export default {
    ...
    dashboard: {
      ...
      rateLimits: {
        ...
        sync7dWindow: '同步 7 天窗口',
        reset7dUsage: '重置 7 天用量',
        upstreamAccount: '上游 AI 账号',
        selectUpstreamAccount: '选择 7 天刷新时间来源账号',
        noSyncableAccount: '此分组暂无包含有效 7 天刷新时间的上游账号，请先实时查询对应 AI 账号。',
        selectedKeys: '已选 {selected} / {total}',
        sync7dSuccess: '已同步 {count} 个 API Key 的 7 天刷新时间',
        reset7dSuccess: '已重置 {count} 个 API Key 的 7 天用量',
        loadAccountsFailed: '加载分组上游账号失败',
