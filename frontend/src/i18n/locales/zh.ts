export default {
  ...
  dashboard: {
    ...
    viewAllUsage: '查看全部',
    quickActions: '快捷操作',
    createApiKey: '查看 API 密钥',
    generateNewKey: '查看并复制管理员分配的 API 密钥',
    viewUsage: '查看使用记录',
  ...
  keys: {
    ...
    readOnlyEmptyDescription: 'API 密钥由管理员创建和管理。如需访问权限，请联系管理员。',
    ...
    resetNow: '即将重置',
    windowAlignTitle: '对齐窗口起始时间',
    windowAlignHint: '把周窗口起始时间对齐到 Codex 官方账号的真实刷新时刻，已用金额保留不变。留空则不修改。',
    window7dStart: '周窗口起始（7d）',
    applyWindowAlign: '应用对齐',
    windowAlignSuccess: '窗口起始时间已更新',
    windowAlignFailed: '更新窗口起始时间失败',
    windowAlignInvalidTime: '时间格式无效',
    expiration: '密钥有效期',
