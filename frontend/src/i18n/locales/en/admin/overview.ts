export default {
    ...
    dashboard: {
      ...
      rateLimits: {
        ...
        sync7dWindow: 'Sync 7-day window',
        reset7dUsage: 'Reset 7-day usage',
        upstreamAccount: 'Upstream AI account',
        selectUpstreamAccount: 'Select the source account for the 7-day reset time',
        noSyncableAccount: 'No upstream account in this group has a valid 7-day reset time. Query the corresponding AI account first.',
        selectedKeys: '{selected} / {total} selected',
        sync7dSuccess: 'Synced the 7-day reset time for {count} API keys',
        reset7dSuccess: 'Reset 7-day usage for {count} API keys',
        loadAccountsFailed: 'Failed to load upstream accounts for this group',
