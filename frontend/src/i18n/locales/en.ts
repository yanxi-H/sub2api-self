export default {
  ...
  dashboard: {
    ...
    createApiKey: 'View API Keys',
    generateNewKey: 'View and copy API keys assigned by an administrator',
  ...
  keys: {
    ...
    readOnlyEmptyDescription: 'API keys are created and managed by administrators. Contact an administrator if you need access.',
    ...
    resetNow: 'Resetting soon',
    windowAlignTitle: 'Align Window Start Time',
    windowAlignHint: 'Align the weekly window start to the Codex official account reset time. Used amount is preserved. Leave empty to skip.',
    window7dStart: 'Weekly Window Start (7d)',
    applyWindowAlign: 'Apply Alignment',
    windowAlignSuccess: 'Window start time updated',
    windowAlignFailed: 'Failed to update window start time',
    windowAlignInvalidTime: 'Invalid time format',
