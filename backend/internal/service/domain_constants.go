...
const (
	...
	SettingKeyRequestArchiveEnabled            = "request_archive_enabled"             // 请求文本存档总开关(默认关)
	SettingKeyRequestArchiveRetentionDays      = "request_archive_retention_days"     // 请求存档保留天数(默认 30)
